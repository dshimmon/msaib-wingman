...
from wingman.shared.briefing_persistence import persist_generated_briefing
from products.atlas.briefing_generator import (
    generate_study_briefing,
)
from products.atlas.briefing_planner import (
...
from products.atlas.retrieval_pipeline import (
    retrieve_question_evidence,
)
from wingman.shared.source_registry import enrich_evidence_sources
from wingman.shared.diagnostic_service import new_trace_id, record_diagnostic
