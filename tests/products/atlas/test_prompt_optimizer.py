...
from wingman.core.prompt_optimizer import (  # noqa: E402
...
class PromptOptimizerUITests(unittest.TestCase):
    ...
    @patch("wingman.core.prompt_optimizer.optimize_prompt", return_value=OPTIMIZED_PROMPT)
    ...
    @patch(
        "wingman.core.prompt_optimizer.optimize_prompt",
    ...
    def test_global_shell_tool_does_not_expand_product_contract_v1(self):
        ...
        self.assertEqual(
            MODULE_OWNERS["wingman.core.prompt_optimizer"], CORE
        )
