...
import briefing_persistence
import briefing_service
import diagnostic_service
import source_registry
import ledger.briefing_repository
from ledger.briefing_repository import (
    get_briefing,
    get_current_briefing_version,
    list_briefing_versions,
)
from ledger.database import connect_database, transaction
from ledger.diagnostic_repository import list_events_for_trace
from ledger.migrations import apply_migrations
from ledger.source_repository import create_source, create_source_version
from ledger.source_repository import update_source
...
class BriefingPersistenceTests(unittest.TestCase):
    ...
    def test_diagnostic_fallback_logs(self):
        with (
            ...
            self.assertLogs("diagnostic_service", level="ERROR"),
        ):
