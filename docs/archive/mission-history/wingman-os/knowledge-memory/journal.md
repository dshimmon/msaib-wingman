<!-- wingman-archive-metadata
{
  ...
  "canonical_replacement": "docs/missions/wingman-os/knowledge-memory/mission.md",
  "archived_from": "docs/missions/wingman-os/knowledge-memory/journal.md"
}
-->

> [!WARNING]
> **HISTORICAL / NONCANONICAL MISSION EVIDENCE.** The sole canonical
> mission record is [`docs/missions/wingman-os/knowledge-memory/mission.md`](../../../../missions/wingman-os/knowledge-memory/mission.md).
