<!-- wingman-archive-metadata
{
  ...
  "canonical_replacement": "docs/missions/wingman-os/structured-retrieval/mission.md",
  "archived_from": "docs/missions/wingman-os/structured-retrieval/journal.md"
}
-->

> [!WARNING]
> **HISTORICAL / NONCANONICAL MISSION EVIDENCE.** The sole canonical
> mission record is [`docs/missions/wingman-os/structured-retrieval/mission.md`](../../../../missions/wingman-os/structured-retrieval/mission.md).
