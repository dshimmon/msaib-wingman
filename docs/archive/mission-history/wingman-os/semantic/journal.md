<!-- wingman-archive-metadata
{
  ...
  "canonical_replacement": "docs/missions/wingman-os/semantic/mission.md",
  "archived_from": "docs/missions/wingman-os/semantic/journal.md"
}
-->

> [!WARNING]
> **HISTORICAL / NONCANONICAL MISSION EVIDENCE.** The sole canonical
> mission record is [`docs/missions/wingman-os/semantic/mission.md`](../../../../missions/wingman-os/semantic/mission.md).
