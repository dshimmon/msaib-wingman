...
<!-- wingman-mission-metadata
{
  ...
  "title": "Atlas Plans Study Actions",
  "call_sign": "Briefing",
  "namespace": "atlas",
  "lifecycle": "completed",
  "priority": "historical",
  ...
  "implementation_commits": [
    "109dc2a3e2502d3142dcba8c7c94fa2e4a191a0f"
  ],
  "pushed": true,
  "merged": true,
  "official_decisions": [
...
Lifecycle: **completed**. Call sign: **Briefing**.

Added sourced, persisted Atlas study briefings.
