...
| `governance/crew-chief` | — | active | yes | committed=local (hash intentionally not self-recorded); pushed=no; merged=no | [Crew Chief Independent Audit](governance/crew-chief/mission.md) |
...
| `wingman-os/hardpoints` | Mission 028 | completed | no | committed=yes; pushed=yes; merged=yes | [Wingman Establishes the Hardpoints](wingman-os/hardpoints/mission.md) |
