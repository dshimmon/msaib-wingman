...
{
  "schema_version": 1,
  "id": "wingman-os/external-knowledge",
  "legacy_aliases": [
    "Mission 006"
  ],
  "title": "External Knowledge",
  "call_sign": "External Knowledge",
  ...
  "implementation_commits": [
    "bd4fdb822da0129ef50781f52fe9553382ede5c2"
  ],
  "pushed": true,
  "merged": true,
  "official_decisions": [
...
Lifecycle: **completed**. Call sign: **External Knowledge**.

Moved knowledge into an external data source.
