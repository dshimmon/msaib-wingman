...
{
  "schema_version": 1,
  "id": "wingman-os/checkpoint",
  "legacy_aliases": [
    "Mission 019"
  ],
  "title": "Wingman Tests Its Retrieval",
  "call_sign": "Checkpoint",
  ...
  "implementation_commits": [
    "390cfc587ddd568d01fbe114f0433b3ea5286737"
  ],
  "pushed": true,
  "merged": true,
  "official_decisions": [
...
Lifecycle: **completed**. Call sign: **Checkpoint**.

Established repeatable retrieval regression tests.
