# Wingman Uses Structured Knowledge

<!-- wingman-mission-metadata
{
  "schema_version": 1,
  "id": "wingman-os/structured-retrieval",
  "legacy_aliases": [
    "Mission 016"
  ],
  "title": "Wingman Uses Structured Knowledge",
  "call_sign": "Structured Retrieval",
  ...
  "implementation_commits": [
    "df78df7d9ac15882b92c3e3464e898e707c5549a"
  ],
  "pushed": true,
  "merged": true,
  "official_decisions": [
...
Lifecycle: **completed**. Call sign: **Structured Retrieval**.

Connected structured interpretation to deterministic retrieval.
