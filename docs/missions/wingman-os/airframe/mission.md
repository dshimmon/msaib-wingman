# Wingman Defines the Boundary

<!-- wingman-mission-metadata
{
  "schema_version": 1,
  "id": "wingman-os/airframe",
  "legacy_aliases": [
    "Mission 027"
  ],
  "title": "Wingman Defines the Boundary",
  "call_sign": "Airframe",
...
Lifecycle: **completed**. Call sign: **Airframe**.

Established product-neutral ownership and compatibility boundaries.
