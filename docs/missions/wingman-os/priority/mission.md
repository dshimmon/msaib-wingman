...
{
  "schema_version": 1,
  "id": "wingman-os/priority",
  "legacy_aliases": [
    "Mission 017"
  ],
  "title": "Wingman Ranks Evidence",
  "call_sign": "Priority",
  ...
  "implementation_commits": [
    "e5095a2e30c52fb9797176b7f9d4b5a78a27a7aa"
  ],
  "pushed": true,
  "merged": true,
  "official_decisions": [
...
Lifecycle: **completed**. Call sign: **Priority**.

Added deterministic evidence ranking.
