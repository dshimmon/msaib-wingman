...
{
  "schema_version": 1,
  "id": "wingman-os/decision-maker",
  "legacy_aliases": [
    "Mission 004"
  ],
  "title": "Decision Maker",
  "call_sign": "Decision Maker",
  ...
  "implementation_commits": [
    "5d9ea052016371e2d219a79e252630b0fa3bbbe7"
  ],
  "pushed": true,
  "merged": true,
  "official_decisions": [
...
Lifecycle: **completed**. Call sign: **Decision Maker**.

Introduced deterministic topic routing and fallback behavior.
