...
{
  "schema_version": 1,
  "id": "wingman-os/knowledge-retrieval",
  "legacy_aliases": [
    "Mission 008"
  ],
  "title": "Knowledge Retrieval",
  "call_sign": "Knowledge Retrieval",
  ...
  "implementation_commits": [
    "ec697da771f3b95725536eca0ecb594c83f12ede"
  ],
  "pushed": true,
  "merged": true,
  "official_decisions": [
...
Lifecycle: **completed**. Call sign: **Knowledge Retrieval**.

Added source-backed knowledge retrieval.
